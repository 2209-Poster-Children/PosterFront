  ...
  return (
    ...
    <div className="cart-item-container">
      ...
      <div className="cart-checkout-container">
        ...
        {cartData.totalPrice != 0?<Link to='/checkout'>
          <button className="cart-checkout-bttn">
            Proceed to Checkout</button></Link>:<div id="cart-come-back-later">Come back when you're actually ready to buy something</div>}
